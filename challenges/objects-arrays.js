...
const universities = graduates.map((obj)=>{return obj.university;});
universities.sort();
...
const contactInfo = graduates.map((obj)=>{return `${obj.first_name} ${obj.email}`});
console.log(contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */

const unisWithUni = universities.filter(string => string.includes('Uni'));
...
*/
const lowPopulationAnimals = zooAnimals.filter(obj => obj.population<5);
